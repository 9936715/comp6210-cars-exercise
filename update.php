...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
    ...
    <div class="col-sm-3">
    <input type="text" name="make" id="make" value="<?php echo $car->make?>" class="form-control">
    </div>
    </div>
<?php
$num=1;
foreach($car->models as $model){
    ...
    echo '<input class="form-control" type="text" name="model_'.$num.'" id="model_'.$num.'" value="'.$model.'">';
    echo "</div>";
    echo "</div>";
    $num++;
}
...
<div class="form-group row">
    ...
    <input type="submit" name="submitUpdate" value="Update" class="btn btn-primary">
    </div>
    </div>
    </form>
</body>
